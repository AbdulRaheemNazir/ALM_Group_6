...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($recaptcha_result['success']) { // Check only the success field for v2
        ...
        // Prepare a SQL query to find the user by email in the 'librarian' table
        $stmt = $db->prepare("SELECT * FROM librarian WHERE email = :email");
        ...
        if ($user) {
            // Check if the email has been verified
                ...
                if (password_verify($password, $user['password_hash'])) {
                    ...
                    // Redirect to the librarian's dashboard or homepage
...
<body>
    <div class="container">
        ...
        <div class="about-section">
            ...
            <form action="login_librarian.php" method="post">
