...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($recaptcha_result['success']) { // Check only the success field for v2
        ...
        // Prepare a SQL query to find the user by email in the 'branch_manager' table
        $stmt = $db->prepare("SELECT * FROM branch_manager WHERE email = :email");
        ...
        if ($user) {
            // Check if the email has been verified
                ...
                if (password_verify($password, $user['password_hash'])) {
                    ...
                    $_SESSION['branch_manager_id'] = $user['branch_manager_id'];
                    $_SESSION['first_name'] = $user['first_name'];

                    // Redirect to the branch manager's dashboard or homepage
...
<body>
    <div class="container">
        ...
        <div class="about-section">
            ...
            <form action="login_branchmanager.php" method="post">
